...
\begin{table}[H]
	...
	\begin{tabularx}{0.95\textwidth}{ |X|X|X| }
		...
		\hline
		Food\&Trink                          & \includegraphics[width=0.05\textwidth]{paymentcategories/fast-food.pdf}       & Ausgaben für Essen und Trinken.                 \\
		\hline
...
\begin{enumerate}[label=\protect\circled{\arabic*}]
	...
	\item Öffnet Zahlung erstellen mit vorgefüllten Werten, um die Übermittlung einer Zahlung festzuhalten.
\end{enumerate}
